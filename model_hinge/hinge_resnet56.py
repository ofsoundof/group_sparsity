...
This is the simplified version of hinge_resnet56_complex.py. A lot of unused functions and procedures are deleted.
"""
__author__ = 'Yawei Li'
import torch
...
def make_model(args, ckp):
    ...
    """
    base_module = import_module('model.' + args.base.lower())
    class Hinge(getattr(base_module, args.base)):
