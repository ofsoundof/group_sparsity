...
def is_supported_instance(module):
    ...
    # if isinstance(module, (nn.Conv2d, nn.Conv3d, nn.Linear, common.DConv2d)):
    #     return True

    # if isinstance(module, (nn.Conv2d, nn.Conv3d, nn.ReLU, nn.PReLU, nn.ELU,
    #                        nn.LeakyReLU, nn.ReLU6, nn.Linear,
    #                        nn.MaxPool2d, nn.AvgPool2d, nn.BatchNorm2d,
    #                        nn.Upsample, nn.AdaptiveMaxPool2d, nn.AdaptiveAvgPool2d,
    #                        nn.ConvTranspose2d, nn.BatchNorm3d,
    #                        nn.MaxPool3d, nn.AvgPool3d, nn.AdaptiveMaxPool3d, nn.AdaptiveAvgPool3d)):
    #     return True
